...
# Output/error logs
OUT_FILE="iComformer_cleavage_energy_space_group_${JOB_ID}.txt"
ERR_FILE="iComformer_cleavage_energy_space_group_err_${JOB_ID}.txt"

# Start logging
{
echo "===== iComformer Cleavage Energy Space Group Training Started: $(date) ====="
