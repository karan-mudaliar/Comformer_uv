...
# Output/error logs
OUT_FILE="iComformer_cleavage_energy_elemental_${JOB_ID}.txt"
ERR_FILE="iComformer_cleavage_energy_elemental_err_${JOB_ID}.txt"

# Start logging
{
echo "===== iComformer Cleavage Energy Elemental Training Started: $(date) ====="
...
nohup python -u comformer/scripts/training_split_scripts/train_iComformer_cleavage_energy_elemental.py &
