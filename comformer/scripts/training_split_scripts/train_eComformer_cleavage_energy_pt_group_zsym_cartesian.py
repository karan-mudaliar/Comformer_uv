...
output_dir = "output/eComformer_cleavage_energy_pt_group_splits_zsym_cartesian"
...
train_prop_model(
    ...
    data_path=os.environ.get("ROBINLAB_DATA_PATH", "/home/mudaliar.k/data") + "/combined_pt_group.csv"
)